...
## Добавлен новый модуль generators
### Описание

данный модуль может генерировать номер карты в заданном диапазоне, а так же выдавать информацию о списке транзакций по заданной валюте и возвращать описание по каждой операции
