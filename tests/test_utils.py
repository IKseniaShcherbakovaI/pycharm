...
def test_transaction2():
    assert transaction('C:/Users/Ксения/Desktop/homework/data/operations8.json') == []


def test_transaction2():
    assert transaction('C:/Users/Ксения/Desktop/homework/data/operations2.json') == []


def test_transaction2():
    assert transaction('C:/Users/Ксения/Desktop/homework/data/operations3.json') == []


def test_transaction3():
    assert transaction('C:/Users/Ксения/Desktop/homework/data/operations.json') == [
        {
            "id": 441945886,
            "state": "EXECUTED",
