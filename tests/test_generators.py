...
def test_filter_by_currency(coll, state="RUB"):
    gen = filter_by_currency(coll, state="USD")
    assert next(gen) == {
        "id": 939719570,
        "state": "EXECUTED",
        "date": "2018-06-30T02:08:58.425572",
    ...
    gen = filter_by_currency(coll, state="RUB")
    assert next(gen) == {
        "id": 873106923,
        "state": "EXECUTED",
        "date": "2019-03-23T01:09:46.296404",
...
def test_card_number_generator(start=1, stop=99):
